...
export type GetDecksQuery = { __typename?: 'Query', getDecks: Array<{ __typename?: 'Deck', id: string, name: string, visibility: string, author: { __typename?: 'User', id: string, username: string } }> };

...
export type CreateDeckMutationMutation = { __typename?: 'Mutation', createDeck: { __typename?: 'Deck', id: string, name: string } };

export type GetDecksQueryVariables = Exact<{ [key: string]: never; }>;


export type GetDecksQuery = { __typename?: 'Query', getDecks: Array<{ __typename?: 'Deck', id: string, name: string, author: { __typename?: 'User', username: string } }> };
